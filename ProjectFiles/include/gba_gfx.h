...
#define A0_8BPP 0x1
//sprite shape
#define A0_SQUARE 0x00 // 0 - 8x8, 1- 16x16, 2 - 32x32, 3 - 64x64
#define A0_WIDE   0x01 // 0 - 16x8, 1 - 32x8, 2 - 32x16, 3 - 64x32
#define A0_TALL   0x02 // 0 - 8x16, 1 - 8x32, 2 - 16x32, 3 - 32x64
//x position mask
#define A1_XMASK 0x1FF
#define A1_FLIPMASK 0x3
#define A1_SIZE_0 0x00 // 8x8, 16x8, 8x16
#define A1_SIZE_1 0x01 // 16x16, 32x8, 8x32
#define A1_SIZE_2 0x02 // 32x32, 32x16, 16x32
#define A1_SIZE_3 0x03 // 64x64, 64x32, 32x64
...
extern void SetObjectvPosition(ObjectAttribute*, fv2 a_position);
//! Hide an object.
