...
void SetObjectvPosition(ObjectAttribute* a_object, fv2 a_position)
{
	a_object->attr0 = (a_object->attr0 & 0xFF00) | (fix2int(a_position.fY) & 0x00FF);
	a_object->attr1 = (a_object->attr1 & 0xFE00) | (fix2int(a_position.fX) & 0x01FF);
}
