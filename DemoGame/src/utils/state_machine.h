...
// Private functions
void _SM_ExternalEvent(SM_StateMachine* self, const SM_StateMachineConst* selfConst, u8 newState, void* pEventData);
void _SM_InternalEvent(SM_StateMachine* self, u8 newState, void* pEventData);
